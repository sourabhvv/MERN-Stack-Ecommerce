  ...
  <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
    {products.map(product => (
      <tr key={product._id} id={`product-${product._id}`} className="hover:bg-gray-100 dark:hover:bg-gray-700">
        ...
        <td className="p-4">
          <p className="text-base font-semibold text-gray-900 dark:text-white">{product.product_name}</p>
        </td>
        ...
        <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{product.stock}</td>
         ...
         <td className="p-4 space-x-2 whitespace-nowrap">
            ...
            <Link  to={`/chats/${product._id}`} id="chats" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
        ...
        <td className="p-4 space-x-2 whitespace-nowrap">
          <button type="button" onClick={() => EditProduct(product._id)} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
            <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fillRule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clipRule="evenodd"></path></svg>
            View
          </button>
          <button type="button" onClick={() => DeleteProduct(product._id)} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
