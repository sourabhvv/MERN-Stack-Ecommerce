    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <a href="" class="flex ml-2 md:mr-24">
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">VFX Bazar</span>
        </a>
      ...
      <div class="flex items-center">
          ...
          <div class="hidden mr-3 -mb-1 sm:block ">
           <Link
            to="/"
            className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 h-12 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300"
            aria-current="page"
          >
        ...
        >
         ...
         <IoIosChatboxes /> All Chats
          ...
          <div class="flex items-center ml-3">
            <div>
              <button type="button" onClick={()=>showProfile()} class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
