...
const ProductCard = ({ image, title, description, stock, price,addToCart,id }) => {
  ...
  <Link to={`/View/${id}`} className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl">
    <img className="h-60 rounded-t-lg object-cover" src={`http://localhost:5000/${image}`} alt={title}   />
  </Link>
